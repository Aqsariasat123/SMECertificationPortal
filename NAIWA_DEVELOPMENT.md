# NAIWA Development & Deployment Guide

## Project Overview
**NAIWA** - SME Certification Platform for UAE businesses.

**Live URL:** https://naiwa.ae
**Legacy URL:** https://naywa.ae (redirects to naiwa.ae)
...
| Domain | SSL | Expires |
|--------|-----|---------|
| naiwa.ae | Let's Encrypt | 2026-05-18 |
| www.naiwa.ae | Let's Encrypt | 2026-05-18 |
| naywa.ae | Let's Encrypt | 2026-05-12 (redirects to naiwa.ae) |
...
```env
NEXT_PUBLIC_API_URL=https://naiwa.ae/api
```

### Nginx Configs

#### Primary Domain (`/etc/nginx/sites-available/naiwa.ae`)
- Proxies `/api` to `10.10.10.241:5001`
- Proxies `/uploads` to `10.10.10.241:5001/uploads`
- Proxies `/` to `10.10.10.241:3000`
- SSL via Let's Encrypt

#### Legacy Domain (`/etc/nginx/sites-available/naywa.ae`)
- 301 redirects all traffic to https://naiwa.ae
...
|---------|---------------|-----------------|
| Next.js Frontend | 3000 | https://naiwa.ae |
| Express API | 5001 | https://naiwa.ae/api |
...
pct exec 106 -- sudo -u postgres psql -c "ALTER USER sme_user WITH PASSWORD 'Jash123qwe..';"
```
...
| Domain | Status |
|--------|--------|
| naywa.ae | Redirects to naiwa.ae |
| sme.byredstone.com | Can be deprecated |
