      ...
      >
        ...
        <Link href="/" className="flex items-center gap-2.5 no-underline relative z-10 mb-6">
          ...
          <div className="flex flex-col gap-1">
            <span className="text-base font-semibold text-white leading-none">Naiwa</span>
        ...
        >
          Naiwa assesses your business against criteria aligned with institutional review standards used by UAE banks and financial institutions.
        </p>
