      ...
      {activeTab === 'credentials' && (
        <div className="space-y-6">
          ...
          <div className="rounded-2xl p-6 text-center" style={{ background: 'linear-gradient(135deg, var(--teal-50) 0%, rgba(74, 143, 135, 0.1) 100%)', border: '1px solid var(--teal-200)' }}>
            ...
            <h3 className="text-xl font-bold mb-2" style={{ color: '#1f2937' }}>Naywa Verified</h3>
            <p className="text-sm mb-2" style={{ color: '#4b5563' }}>This company has been verified and certified by Naywa</p>
            {sme.submittedDate && (
