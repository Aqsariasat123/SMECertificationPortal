...
export default function NotificationsPage() {
  const [notifications, setNotifications] = useState<Notification[]>([
    ...
    },
    {
      ...
      type: 'info',
      title: 'System Update',
      message: 'New features are now available. Check out the improved dashboard experience.',
    ...
    },
    {
      id: '3',
      type: 'message',
      title: 'Message from SME',
      message: 'You have received a response to your introduction request.',
