...
export const metadata: Metadata = {
  ...
  description: 'UAE SME Readiness Certification Portal - Get certified, gain credibility, and connect with investors and partners. Trusted by businesses across the UAE.',
  keywords: ['SME certification', 'UAE business', 'business certification', 'SME registry', 'investor connect', 'business credibility'],
