...
export default function LandingPage() {
  ...
  return (
    <div style={{ fontFamily: 'var(--font-source-sans), Source Sans 3, sans-serif', color: '#1A2F2F', background: '#FFFFFF' }}>
      {/* NAV */}
      <nav
        className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-12 h-16"
        style={{ background: 'rgba(255,255,255,0.92)', backdropFilter: 'blur(12px)', borderBottom: '1px solid #b8d5d5' }}
      >
        <Link href="/" className="flex items-center gap-2.5 no-underline">
          <div className="w-[42px] h-[42px] rounded-[10px] flex items-center justify-center" style={{ background: '#1A3838' }}>
          ...
          <div className="flex flex-col gap-1.5">
            <span className="font-semibold text-lg leading-none" style={{ color: '#1A2F2F' }}>NAIWA</span>
            <span className="text-[11px] leading-none tracking-wide" style={{ color: '#4A5858' }}>SME Certification Platform</span>
          </div>
        </Link>

        <ul className="hidden md:flex items-center gap-8 list-none m-0 p-0">
          <li><Link href="/about" className="text-sm font-medium no-underline transition-colors hover:text-[#1A3838]" style={{ color: '#4A5858' }}>About</Link></li>
          <li><Link href="/methodology" className="text-sm font-medium no-underline transition-colors hover:text-[#1A3838]" style={{ color: '#4A5858' }}>Methodology</Link></li>
          <li><Link href="/framework" className="text-sm font-medium no-underline transition-colors hover:text-[#1A3838]" style={{ color: '#4A5858' }}>Framework</Link></li>
          <li><Link href="/registry/verify" className="text-sm font-medium no-underline transition-colors hover:text-[#1A3838]" style={{ color: '#4A5858' }}>Verify</Link></li>
          <li><Link href="/contact" className="text-sm font-medium no-underline transition-colors hover:text-[#1A3838]" style={{ color: '#4A5858' }}>Contact</Link></li>
        </ul>
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <Link
            href="/login"
            className="hidden sm:flex px-3 md:px-5 py-2 text-xs md:text-sm font-medium rounded-lg transition-all no-underline hover:bg-[#dceaea]"
            style={{ color: '#1A3838', border: '1.5px solid #1A3838', background: 'none' }}
          >
            Sign In
          </Link>
          <Link
            href="/register"
            className="hidden sm:flex px-3 md:px-5 py-2 md:py-2.5 text-xs md:text-sm font-semibold rounded-lg transition-all no-underline hover:bg-[#3d7a7a] whitespace-nowrap"
            style={{ color: 'white', background: '#1A3838', border: 'none' }}
          >
            Start Certification
          </Link>
          ...
          <button
            ...
            style={{ background: mobileMenuOpen ? '#dceaea' : 'transparent' }}
            aria-label="Toggle menu"
          >
            {mobileMenuOpen ? (
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#1A3838" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {mobileMenuOpen && (
        <div
          ...
          style={{ background: 'rgba(255,255,255,0.98)', backdropFilter: 'blur(12px)', borderBottom: '1px solid #b8d5d5' }}
        >
          <div className="px-6 py-4">
              ...
              {[
                ...
                <li key={link.href}>
                  <Link
                    ...
                    className="block py-3 text-sm font-medium no-underline transition-colors hover:text-[#1A3838]"
                    style={{ color: '#4A5858', borderBottom: '1px solid #dceaea' }}
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <div className="flex gap-3 mt-4 pt-2">
              <Link
                ...
                style={{ color: '#1A3838', border: '1.5px solid #1A3838' }}
              >
                Sign In
              </Link>
              <Link
                ...
                style={{ color: 'white', background: '#1A3838' }}
              >
                Start Certification
              </Link>
            </div>
          ...
          <div className="max-w-[680px]">
            ...
            <div>
              <Link
                ...
                style={{ color: '#1A3838', background: '#FFFFFF', boxShadow: '0 8px 24px rgba(0,0,0,0.25)' }}
              >
                Start Certification
      ...
      {/* STRIP */}
      <div className="py-[18px] overflow-hidden" style={{ borderTop: '1px solid #b8d5d5', borderBottom: '1px solid #b8d5d5', background: '#f0f5f5' }}>
        <div className="flex gap-0 justify-center flex-wrap">
          <span className="text-xs font-medium tracking-[0.1em] uppercase py-1 px-7" style={{ color: '#4A5858', borderRight: '1px solid #b8d5d5' }}>Five-Pillar Framework</span>
          <span className="text-xs font-medium tracking-[0.1em] uppercase py-1 px-7" style={{ color: '#4A5858', borderRight: '1px solid #b8d5d5' }}>Independent Assessment</span>
          <span className="text-xs font-medium tracking-[0.1em] uppercase py-1 px-7" style={{ color: '#4A5858', borderRight: '1px solid #b8d5d5' }}>Point-in-Time Verification</span>
          <span className="text-xs font-medium tracking-[0.1em] uppercase py-1 px-7" style={{ color: '#4A5858' }}>UAE Market-Aligned Standards</span>
        </div>
      </div>
      ...
      <section className="py-24 px-6" style={{ background: '#FFFFFF' }}>
        <div className="max-w-[1040px] mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="reveal text-[11px] font-semibold tracking-[0.16em] uppercase mb-4" style={{ color: '#1A3838' }}>About Naiwa</p>
              <h2 className="reveal text-[clamp(28px,3.5vw,38px)] font-bold leading-[1.15] tracking-[-0.01em] mb-5" style={{ fontFamily: 'var(--font-playfair), Playfair Display, serif', color: '#1A2F2F' }}>Independent SME Certification for the UAE Market</h2>
              <p className="reveal text-base leading-[1.75] mb-5" style={{ color: '#4A5858' }}>
              ...
              <p className="reveal text-base leading-[1.75] mb-6" style={{ color: '#4A5858' }}>
            ...
            <div className="reveal grid grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="p-6 rounded-xl" style={{ background: '#f0f5f5', border: '1px solid #b8d5d5' }}>
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center mb-3" style={{ background: '#dceaea' }}>
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="#1A3838" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
                      <polyline points="22 4 12 14.01 9 11.01"/>
                    </svg>
                  </div>
                  <p className="text-[13px] font-semibold mb-1" style={{ color: '#1A2F2F' }}>{item.title}</p>
                  <p className="text-xs leading-[1.5]" style={{ color: '#4A5858' }}>{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* METHODOLOGY - Summary */}
      <section id="methodology" className="py-24 px-6" style={{ background: '#1A2F2F' }}>
        <div className="max-w-[1040px] mx-auto">
          <p className="reveal text-[11px] font-semibold tracking-[0.16em] uppercase mb-4" style={{ color: '#3d7a7a' }}>Assessment Methodology</p>
          ...
          <div className="grid md:grid-cols-3 gap-0 relative mb-14">
            <div className="hidden md:block absolute h-[1px] top-7" style={{ left: 'calc(16.66% + 20px)', right: 'calc(16.66% + 20px)', background: 'linear-gradient(90deg, #1A3838 0%, #3d7a7a 50%, #1A3838 100%)' }} />
            {[
              ...
              <div key={s.num} className="reveal text-center px-6">
                <div
                  ...
                  style={{ background: '#1A3838', fontFamily: 'var(--font-playfair), Playfair Display, serif', color: '#FFFFFF' }}
                >
                  {s.num}
                </div>
      ...
      {/* FRAMEWORK */}
      <section id="framework" className="py-24 px-6" style={{ background: '#f0f5f5' }}>
        <div className="max-w-[1040px] mx-auto">
          <p className="reveal text-[11px] font-semibold tracking-[0.16em] uppercase mb-4" style={{ color: '#1A3838' }}>Assessment Framework</p>
          <h2 className="reveal text-[clamp(28px,3.5vw,38px)] font-bold leading-[1.15] tracking-[-0.01em] mb-5" style={{ fontFamily: 'var(--font-playfair), Playfair Display, serif', color: '#1A2F2F' }}>What Naiwa Certifies</h2>
          <p className="reveal text-base leading-[1.75] max-w-[640px]" style={{ color: '#4A5858' }}>
          ...
          <div className="reveal grid grid-cols-2 md:grid-cols-5 gap-[1px] mt-14 rounded-2xl overflow-hidden" style={{ background: '#b8d5d5', border: '1px solid #b8d5d5' }}>
            {[
              ...
              <div key={p.num} className={`p-9 transition-colors hover:bg-[#dceaea] ${i === 4 ? 'col-span-2 md:col-span-1' : ''}`} style={{ background: '#FFFFFF' }}>
                <p className="text-[13px] font-bold tracking-[0.05em] mb-4" style={{ fontFamily: 'var(--font-playfair), Playfair Display, serif', color: '#1A3838' }}>Pillar {p.num}</p>
                <p className="text-[15px] font-semibold leading-[1.4]" style={{ color: '#1A2F2F' }}>{p.name}</p>
              </div>
            ))}
          </div>
          <p className="reveal text-sm leading-[1.65] max-w-[680px] mt-7" style={{ color: '#4A5858' }}>
            Each pillar is assessed against documented evidence. Certification is issued, deferred, or declined based on <strong style={{ color: '#1A2F2F', fontWeight: 600 }}>what your records demonstrate</strong> — not projections or intent.
          </p>
          <Link
            href="/framework"
      ...
      {/* STATISTICS STRIP */}
      <section className="py-16 px-6" style={{ background: '#FFFFFF', borderTop: '1px solid #b8d5d5', borderBottom: '1px solid #b8d5d5' }}>
        <div className="max-w-[1040px] mx-auto">
          <div className="reveal grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4">
            {[
              ...
              <div key={i} className="text-center">
                <p className="text-[clamp(32px,4vw,48px)] font-bold leading-none mb-2" style={{ fontFamily: 'var(--font-playfair), Playfair Display, serif', color: '#1A3838' }}>{stat.value}</p>
                <p className="text-[14px] font-semibold mb-1" style={{ color: '#1A2F2F' }}>{stat.label}</p>
                <p className="text-[12px]" style={{ color: '#4A5858' }}>{stat.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* TRUST INDICATORS */}
      <section className="py-20 px-6" style={{ background: '#1A2F2F' }}>
        <div className="max-w-[1040px] mx-auto">
          <p className="reveal text-[11px] font-semibold tracking-[0.16em] uppercase mb-4 text-center" style={{ color: '#3d7a7a' }}>Why Trust Naiwa</p>
          ...
          <div className="reveal grid md:grid-cols-3 gap-6">
            {[
              {
                icon: (
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="#3d7a7a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
                  </svg>
                ),
          ...
          <div className="reveal mt-12 pt-10 flex flex-wrap justify-center gap-8 md:gap-12" style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}>
            {[
              ...
              <div key={i} className="flex items-center gap-2">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="#3d7a7a" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* SCOPE */}
      <section className="py-24 px-6" style={{ background: '#f0f5f5' }}>
        <div className="max-w-[1040px] mx-auto">
          <p className="reveal text-[11px] font-semibold tracking-[0.16em] uppercase mb-4" style={{ color: '#1A3838' }}>Scope & Limitations</p>
          <h2 className="reveal text-[clamp(28px,3.5vw,38px)] font-bold leading-[1.15] tracking-[-0.01em] mb-5" style={{ fontFamily: 'var(--font-playfair), Playfair Display, serif', color: '#1A2F2F' }}>What Certification Means</h2>
          <div className="reveal max-w-[760px] p-12 mt-12 rounded-2xl" style={{ border: '1px solid #b8d5d5', background: '#FFFFFF' }}>
            <p className="text-[15px] leading-[1.8] mb-5" style={{ color: '#4A5858' }}>Naiwa certification is an independent, documentation-based assessment conducted by a private entity. It is important to understand what it does and does not represent.</p>
            <p className="text-[15px] leading-[1.8] mb-5" style={{ color: '#4A5858' }}>Certification confirms that your submitted documentation meets Naiwa&apos;s structured assessment criteria at the time of review. <strong style={{ color: '#1A2F2F', fontWeight: 600 }}>It does not constitute regulatory approval, a government endorsement, or a guarantee of financing.</strong> It does not predict future business performance or ongoing compliance.</p>
            <p className="text-[15px] leading-[1.8]" style={{ color: '#4A5858' }}>Institutions that receive your certificate are responsible for their own due diligence and lending or partnership decisions. <strong style={{ color: '#1A2F2F', fontWeight: 600 }}>Naiwa operates as assessment infrastructure — not as an intermediary, broker, or advisor.</strong></p>
            <Link
      ...
      {/* CTA */}
      <section className="py-14 md:py-16 px-6 text-center relative overflow-hidden" style={{ background: '#1A3838' }}>
        ...
        <Link
          ...
          style={{ color: '#1A3838', background: '#FFFFFF' }}
        >
          Start Certification
