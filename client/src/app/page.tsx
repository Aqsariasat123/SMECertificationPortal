    ...
    <div style={{ fontFamily: 'var(--font-dm-sans), DM Sans, sans-serif', color: '#1A2A2A', background: '#FFFFFF' }}>
      ...
      >
        ...
        <div className="flex items-center gap-2 md:gap-3">
          <Link
            href="/login"
            className="px-3 md:px-5 py-2 md:py-2.5 text-xs md:text-sm font-medium rounded-lg transition-all no-underline hover:bg-[#E8F4F4] whitespace-nowrap"
        ...
        <div className="max-w-[1040px] mx-auto">
          <div className="flex flex-col md:grid md:grid-cols-[140px_1fr] gap-6 items-start pb-7 md:pb-9 mb-6 md:mb-7" style={{ borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
            ...
            <ul className="flex flex-wrap list-none m-0 p-0 pt-1" style={{ gap: '6px 16px' }}>
              ...
              <li><Link href="/certification-fees" className="text-[12px] md:text-[13px] no-underline transition-colors hover:text-white/80" style={{ color: 'rgba(255,255,255,0.45)' }}>Fees and Services</Link></li>
              <li><Link href="/terms" className="text-[12px] md:text-[13px] no-underline transition-colors hover:text-white/80" style={{ color: 'rgba(255,255,255,0.45)' }}>Terms of Service</Link></li>
              <li><Link href="/privacy" className="text-[12px] md:text-[13px] no-underline transition-colors hover:text-white/80" style={{ color: 'rgba(255,255,255,0.45)' }}>Privacy Policy</Link></li>
              <li><Link href="/legal-notice" className="text-[12px] md:text-[13px] no-underline transition-colors hover:text-white/80" style={{ color: 'rgba(255,255,255,0.45)' }}>Legal Notice</Link></li>
              ...
              <li><span className="text-[12px] md:text-[13px]" style={{ color: 'rgba(255,255,255,0.45)' }}>United Arab Emirates</span></li>
            </ul>
          </div>
