      ...
      <section className="py-16" style={{ background: 'white' }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="glass-card rounded-lg p-10">
            <h2 className="text-2xl font-semibold mb-3" style={{ color: 'var(--graphite-900)' }}>
              Ready to Get Certified?
            </h2>
            <p className="text-sm mb-6" style={{ color: 'var(--foreground-muted)' }}>
              Join hundreds of SMEs who have gained credibility and new opportunities through our platform.
            </p>
            <Link
              href="/register"
              className="btn-teal inline-flex items-center gap-2 px-6 py-3 text-sm font-medium rounded-lg"
            >
