              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm" style={{ color: 'var(--graphite-500)' }}>{selectedTicket.user.email}</p>
                  </div>
                </div>
                <select
                      ...
                      <div key={msg.id} className={`flex mb-4 ${isAdmin ? 'justify-end' : 'justify-start'}`}>
                        ...
                        {!isAdmin && (
                          <div className="flex items-start gap-3 max-w-[70%]">
                            <div className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'var(--graphite-600)' }}>
